...
const Introduction = () => {
  return (
    <div className='md:mt-48 mt-20 md:mx-20 mx-4'>
      <div>
        {/* 
          Provide the width and height of the image in pixels 
          or use layout="fixed" or layout="responsive" to let Next.js handle the sizing.
        */}
        <Image
          src="/437104538_450567847342842_6434418363123287842_n.jpg"
          alt=""
      ...
      <div>
        <ul className="text-white mt-8 flex flex-col justify-center md:items-center gap-2 text-[17px]">
          ...
          <li>- 🌱 I am interested in Data analysis and machine learning</li>
